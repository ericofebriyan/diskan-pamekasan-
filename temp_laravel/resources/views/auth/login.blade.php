<x-guest-layout>
    ...
    @if (session('error'))
        <div class="mb-6 p-4 rounded-xl bg-red-50 border border-red-100 text-red-600 text-sm font-medium flex items-center gap-3">
    ...
    <form method="POST" action="{{ route('login') }}" class="space-y-6">
        ...
        <div class="relative py-4">
            ...
            <div class="relative flex justify-center text-xs uppercase">
                <span class="bg-white px-4 text-slate-500 font-bold tracking-widest">Atau masuk dengan</span>
            </div>
        </div>
