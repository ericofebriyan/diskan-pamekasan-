...
@section('title', 'Renja - Dinas Perikanan Pamekasan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
            <h1 x-show="show" x-transition:enter="transition ease-out duration-700"
                ...
                Rencana Kerja <span class="text-emerald-400">(Renja)</span>
            </h1>
            <p x-show="show" x-transition:enter="transition ease-out duration-700 delay-300"
                ...
                Panduan operasional tahunan Perangkat Daerah untuk pembangunan berkelanjutan.
            </p>
        </div>
    </div>
</div>
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-emerald-100">
        <div class="p-8 md:p-12">
            <div class="prose prose-emerald lg:prose-lg max-w-none text-gray-600">
                <div class="bg-gradient-to-br from-slate-50 to-emerald-50/30 p-8 md:p-10 rounded-3xl mb-12 border border-emerald-100 shadow-sm relative">
                    <div class="relative z-10">
                        ...
                        <p class="leading-relaxed m-0 text-gray-700">
                            Berdasarkan Peraturan Menteri Dalam Negeri Nomor 86 Tahun 2017, Organisasi Perangkat Daerah (OPD) menyusun Rencana Kerja (Renja) yang memuat program, kegiatan, lokasi, dan pendanaan sesuai dengan tugas dan fungsi setiap Perangkat Daerah yang disusun berpedoman kepada Rencana Strategis (Renstra) Perangkat Daerah dan Rencana Kerja Pembangunan Daerah (RKPD).
                        </p>
                    </div>
                </div>
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <div>
                        <h2 class="text-2xl font-bold text-gray-800 m-0">Dokumen Renja Dinas Perikanan</h2>
                        <p class="text-sm text-gray-500 m-0">Berikut adalah Renja Dinas Perikanan Kabupaten Pamekasan, dalam rentan waktu 5 tahun terakhir:</p>
                    </div>
                </div>
                ...
                <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-gray-500 italic">Belum ada dokumen Renja yang tersedia.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-blue-700 text-sm font-medium m-0">
                                Klik tombol <strong>PDF</strong> pada tabel di atas untuk mengunduh dokumen resmi Rencana Kerja (Renja). Dokumen ini diterbitkan setiap tahun sebagai acuan kerja operasional.
                            </p>
                        </div>
                    </div>
                </div>
