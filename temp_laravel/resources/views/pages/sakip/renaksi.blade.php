...
@section('title', 'Rencana Aksi - Dinas Perikanan Pamekasan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
            <h1 x-show="show" x-transition:enter="transition ease-out duration-700"
                ...
                Rencana <span class="text-emerald-400">Aksi (Renaksi)</span>
            </h1>
            <p x-show="show" x-transition:enter="transition ease-out duration-700 delay-300"
                ...
                Breakdown target dan fokus kegiatan prioritas instansi.
            </p>
        </div>
    </div>
</div>
    ...
    <div class="bg-white rounded-3xl shadow-2xl overflow-hidden border border-emerald-100">
        <div class="p-8 md:p-12">
            <div class="prose prose-emerald lg:prose-lg max-w-none text-gray-600">
                <div class="bg-gradient-to-br from-slate-50 to-emerald-50/20 p-8 rounded-3xl mb-12 border border-emerald-100 relative">
                    <p class="leading-relaxed mb-6 font-medium text-gray-800">
                        Rencana Aksi adalah Dokumen yang memuat sasaran, strategi, dan fokus kegiatan prioritas yang digunakan sebagai acuan lembaga, dan pemerintah daerah dalam melaksanakan suatu tema kebijakan tertentu.
                    </p>
                    <p class="leading-relaxed mb-6 text-sm">
                        Dokumen Rencana Aksi diperlukan untuk dapat melakukan breakdown terhadap rencana pencapaian target dan kinerja yang telah disusun di dalam Dokumen Rencana Kerja. Hal ini diperlukan sebagai upaya untuk dapat memfokuskan Rancangan Anggaran Biaya yang telah ditentukan melalui PPAS sehingga diharapkan kinerja yang menjadi target secara terukur dapat dievaluasi pencapainnya melalui langkah monitoring dan evaluasi secara berkala.
                    </p>
                </div>
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 m-0">Dokumen Rencana Aksi Dinas Perikanan</h2>
                </div>
                ...
                <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-gray-500 italic">Belum ada dokumen Rencana Aksi yang tersedia.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-emerald-700 text-sm font-medium m-0">
                                Klik tombol <strong>PDF</strong> pada tabel di atas untuk mengunduh dokumen resmi Rencana Aksi. Dokumen ini merupakan instrumen monitoring pencapaian target kinerja.
                            </p>
                        </div>
                    </div>
                </div>
