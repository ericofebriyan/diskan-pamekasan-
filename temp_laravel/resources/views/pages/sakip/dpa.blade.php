...
@section('title', 'Dokumen Pelaksanaan Anggaran (DPA)')
    ...
    <div class="pt-28 pb-12 min-h-screen bg-slate-50 relative overflow-hidden">
        ...
        <div class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="mb-10 bg-white/60 backdrop-blur-md rounded-2xl shadow-sm border border-white/50 p-6 md:p-8 relative overflow-hidden"
                data-aos="fade-up">
                <div class="absolute left-0 top-0 bottom-0 w-1.5 bg-blue-600 mt-6 mb-6 rounded-r-lg ml-0.5 md:ml-0"></div>
                <div class="pl-6 md:pl-8">
                    <p class="text-slate-700 leading-8 text-base md:text-lg mb-6 text-justify">
                        Dokumen Pelaksanaan Anggaran (DPA) merupakan dokumen yang memuat pendapatan, belanja, dan pembiayaan
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody class="divide-y divide-slate-100">
                            <tr class="hover:bg-blue-50 transition-colors">
                                ...
                                <td class="px-8 py-6 text-slate-600">Dokumen Pelaksanaan Anggaran Tahun 2024</td>
                                <td class="px-8 py-6 text-center">
                                    <button class="text-blue-600 hover:text-blue-800 font-bold">Download</button>
                                </td>
                            </tr>
                        </tbody>
                    </table>
