...
@section('title', 'DPA - Dinas Perikanan Pamekasan')
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        <div class="text-center" x-data="{ show: false }" x-init="setTimeout(() => show = true, 100)">
            <h1 x-show="show" x-transition:enter="transition ease-out duration-700"
                ...
                Dokumen Pelaksanaan <span class="text-emerald-400">Anggaran (DPA)</span>
            </h1>
            <p x-show="show" x-transition:enter="transition ease-out duration-700 delay-300"
                ...
                Dasar pelaksanaan kegiatan dan penggunaan anggaran Dinas Perikanan.
            </p>
        </div>
    </div>
</div>
        ...
        <div class="p-8 md:p-12">
            <div class="prose prose-emerald lg:prose-lg max-w-none text-gray-600">
                <p class="leading-relaxed mb-6 font-medium text-gray-800">
                    Dokumen Pelaksanaan Anggaran (DPA) adalah dokumen yang berisi rincian anggaran yang telah disetujui dan menjadi dasar pelaksanaan kegiatan serta penggunaan anggaran oleh instansi pemerintah. 
                </p>
                <p class="leading-relaxed mb-6">
                    DPA berfungsi sebagai acuan dalam merealisasikan anggaran, memastikan bahwa setiap kegiatan yang direncanakan dapat terlaksana sesuai dengan alokasi dana yang telah ditetapkan, serta sebagai alat pengendalian dan evaluasi keuangan.
                </p>
                ...
                <div class="flex items-center gap-4 mb-8">
                    ...
                    <h2 class="text-2xl font-bold text-gray-800 m-0">Daftar Dokumen DPA</h2>
                </div>
                ...
                <div class="overflow-x-auto rounded-2xl border border-gray-100 shadow-sm">
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tbody class="bg-white divide-y divide-gray-100">
                            ...
                            @empty
                            <tr>
                                <td colspan="4" class="px-6 py-10 text-center text-gray-500 italic">Belum ada dokumen DPA yang tersedia.</td>
                            </tr>
                            @endforelse
                        </tbody>
                    </table>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="text-emerald-700 text-sm font-medium m-0">
                                Klik tombol <strong>PDF</strong> pada tabel di atas untuk mengunduh dokumen resmi DPA. Dokumen ini merupakan dasar pelaksanaan anggaran Dinas Perikanan Kabupaten Pamekasan.
                            </p>
                        </div>
                    </div>
                </div>
