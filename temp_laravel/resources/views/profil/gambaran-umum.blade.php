...
@section('content')
    ...
    <div class="relative pt-32 pb-20 bg-emerald-900 overflow-hidden">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
            <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-4 tracking-tight">GAMBARAN UMUM</h1>
            ...
            <div class="grid grid-cols-1 lg:grid-cols-2">
                ...
                <div class="p-8 md:p-12 lg:p-16 space-y-8">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6 pt-6">
                        <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 group hover:bg-emerald-600 transition-all duration-300">
                            ...
                            <p class="text-sm text-slate-500 group-hover:text-emerald-50 transition-colors">Perda No. 9/2022 & Perbup No. 21/2023</p>
                        </div>
                        <div class="bg-slate-50 p-6 rounded-2xl border border-slate-100 group hover:bg-blue-600 transition-all duration-300">
