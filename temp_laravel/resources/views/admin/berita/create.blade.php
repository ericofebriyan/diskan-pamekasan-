                ...
                <div class="p-6 text-gray-900">
                    ...
                    <form action="{{ route('admin.berita.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="date" name="tanggal_berita" id="tanggal_berita" class="shadow appearance-none border rounded w-full py-2 px-3 text-gray-700 leading-tight focus:outline-none focus:shadow-outline" value="{{ old('tanggal_berita') }}">
                            <p class="text-gray-500 text-xs mt-1">Kosongkan jika ingin menggunakan tanggal hari ini.</p>
